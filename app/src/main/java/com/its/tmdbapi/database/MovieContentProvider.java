...
public class MovieContentProvider extends ContentProvider {
    ...
    public static final String AUTORITY = "com.its.tmdbapi.database.ContentProvider";
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        if (uriMatcher.match(uri) == ALL_MOVIES) {
            ...
            long result = db.insertWithOnConflict(MovieTableHelper.TABLE_NAME, null, values, SQLiteDatabase.CONFLICT_REPLACE);
